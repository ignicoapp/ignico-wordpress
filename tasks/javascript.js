...
let productionBuildTasks  = ['javascript:lint', 'javascript:compile', 'javascript:rename'];
...
/**
* Task provided to add min suffix to output js files
*/
gulp.task('javascript:rename', function () {
