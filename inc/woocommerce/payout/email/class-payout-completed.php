 ...
 * @subpackage IgnicoWordPress/woocommerce/coupon/email
 */
class Payout_Completed extends \WC_Email {
	...
	public function __construct( $plugin ) {
		...
		$this->id = 'wc_payout_completed';

		// this is the title in WooCommerce Email settings.
		$this->title = __( 'Payout completed', 'ignico' );

		// this is the description in WooCommerce email settings.
		$this->description = __( 'E-mails is sent when payout is marked as completed.', 'ignico' );

		// these are the default heading and subject lines that can be overridden using the settings.
		$this->heading = __( 'Payout completed', 'ignico' );
		$this->subject = __( 'Payout completed', 'ignico' );
		$this->intro   = __( 'Your payout request status has been changed to completed.', 'ignico' );

		// these define the locations of the templates that this email should use, we'll just use the new order template since this email is similar.
		$this->template_html  = '/payout-completed-html.php';
		$this->template_plain = '/payout-completed-txt.php';

		// Trigger on when payout is marked as completed.
		add_action( 'ignico_payout_pending_to_completed', array( $this, 'trigger' ) );
